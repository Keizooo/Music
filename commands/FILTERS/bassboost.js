...
if (!args[0]) {
        ...
        ]);	const msg = await message.channel.send(`<a:loading1:904369053144068096> Turning on **bassboost**.`);
		...
		const msg = await message.channel.send(`<a:loading1:904369053144068096> Turning off **bassboost**.`);
