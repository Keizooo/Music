...
if (!args[0]) {
	player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:loading1:904369053144068096> Turning on **pop**.`);
		...
		const msg = await message.channel.send(`<a:loading1:904369053144068096> Turning off **pop**.`);
			const embed = new MessageEmbed()
