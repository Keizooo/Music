...
module.exports = { 
    ...
    run: async (client, message) => {
        const msg = await message.channel.send("<a:loading1:904369053144068096> Turning on **Nightcore**.");
...
const player = message.client.manager.players.get(message.guild.id)
  ...
  player.setNightcore(!player.nightcore);
        ...
        const nightcored = new MessageEmbed()
            .setTitle("<a:ttick:916689402531561492> Turned on : nightcore ")
            .setColor('#000001');
		...
		player.clearEffects()
		const msg = await message.channel.send(`<a:loading1:904369053144068096> Turning off **nightcore**.`);
