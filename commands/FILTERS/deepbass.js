...
player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:loading1:904369053144068096> Turning on **deepbass**.`);
		...
		player.clearEffects()
		const msg = await message.channel.send(`<a:loading1:904369053144068096> Turning off **deepbass**.`);
			const embed = new MessageEmbed()
